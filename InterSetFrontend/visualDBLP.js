...
redApp.controller('redCtrl', function ($scope, $route, $http, $timeout, $interval, $q, $location, $anchorScroll) {
    ...
    $scope.init = function () {
        if (sessionStorage.getItem('username') !== null) {
            $("#loginForm").hide();
            var loginLink = "http://127.0.0.1:8089/DBLP/login";
    ...
    $scope.onTabSelected = function (tab) {
        ...
        if (typeof tab === 'string') {
            switch (tab) {
                case 'elementInfo':
                    route = 'elementInfoDBLP.html';
                    break;
                case 'attributeInfo':
                    route = 'attributeInfoDBLP.html';
                    break;
                case 'globalInfo':
                    route = 'globalInfoDBLP.html';
                    break;
                default:
                    route = tab;
                    break;
    ...
    $scope.tabs = [{
        ...
        content: 'elementInfoDBLP.html'
    }, {
        slug: 'attributeInfo',
        title: "Attribute - based exploration",
        content: 'attributeInfoDBLP.html'
    }, {
        slug: 'globalInfo',
        title: "Property - based exploration",
        content: 'globalInfoDBLP.html'
    }];
    ...
    $scope.runCLUSRMSettings = function () {
        ...
        if ($scope.conditionw1 && $scope.conditionw2 && $scope.conditionElementsSelection) {
            var clusLink = "http://127.0.0.1:8089/DBLP/clusrmSettings";
            var options = {
                url: clusLink,
                method: 'POST',
                params: {
    ...
    $scope.runCLUSRMSettingsElements = function () {
        ...
        if ($scope.conditionElements && $scope.conditionw1selection && $scope.conditionw2selection) {
            ...
            var clusLink = "http://127.0.0.1:8089/DBLP/clusrmSettingsElements";
            var options = {
                url: clusLink,
                method: 'POST',
                params: {},
    ...
    $scope.saveCLUSRMRedescriptions = function () {
        ...
        if (!$scope.result) window.alert('Select redescriptions to save');
            ...
            var clusLink = "http://127.0.0.1:8089/DBLP/saveCLUSRMRedescriptions";
            var options = {
                url: clusLink,
                method: 'POST',
                params: {},
            ...
            $http(options)
                .success(function (data) {
                    ...
                    //$scope.allRedUrl = "http://127.0.0.1:8089/DBLP/allRedescriptions";
                    //$scope.compglInfo();
                    //window.location.reload();
                    $scope.result = "";
                    //location.reload(true);
		...
		console.log($scope.SOMInput);},2000);*/
            ...
            var timer6 = $timeout(function () {
                ...
                if ($scope.action.type == "load") {
                    ...
                    var options1 = {
                        url: "http://127.0.0.1:8089/DBLP/redescriptionElement",
                        method: 'GET',
                        params: {}
                    };
