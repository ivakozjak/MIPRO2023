...
redApp.controller('redCtrl', function ($scope, $route, $http, $timeout, $interval, $q, $location, $anchorScroll) {
    ...
    $scope.onTabSelected = function (tab) {
        ...
        if (typeof tab === 'string') {
            switch (tab) {
                case 'elementInfo':
                    route = 'elementInfoTrade.html';
                    break;
                case 'attributeInfo':
                    route = 'attributeInfoTrade.html';
                    break;
                case 'globalInfo':
                    route = 'globalInfoTrade.html';
                    break;
                default:
                    route = tab;
                    break;
    ...
    $scope.tabs = [{
        ...
        content: 'elementInfoTrade.html'
    }, {
        slug: 'attributeInfo',
        title: "Attribute - based exploration",
        content: 'attributeInfoTrade.html'
    }, {
        slug: 'globalInfo',
        title: "Property - based exploration",
        content: 'globalInfoTrade.html'
    }];
    ...
    $scope.runCLUSRMSettings = function () {
        ...
        if ($scope.conditionw1 && $scope.conditionw2 && $scope.conditionElementsSelection) {
            var clusLink = "http://127.0.0.1:8089/trade/clusrmSettings";
            var options = {
                url: clusLink,
                method: 'POST',
                params: {
    ...
    $scope.runCLUSRMSettingsElements = function () {
        ...
        if ($scope.conditionElements && $scope.conditionw1selection && $scope.conditionw2selection) {
            ...
            var clusLink = "http://127.0.0.1:8089/trade/clusrmSettingsElements";
            var options = {
                url: clusLink,
                method: 'POST',
                params: {},
    ...
    $scope.saveCLUSRMRedescriptions = function () {
        ...
        if (!$scope.result) window.alert('Select redescriptions to save');
            ...
            var clusLink = "http://127.0.0.1:8089/trade/saveCLUSRMRedescriptions";
            var options = {
                url: clusLink,
                method: 'POST',
                params: {},
            ...
            $http(options)
                .success(function (data) {
                    ...
                    //$scope.allRedUrl = "http://127.0.0.1:8089/trade/allRedescriptions";
                    //$scope.compglInfo();
                    //window.location.reload();
                    $scope.result = "";
                    //location.reload(true);
		...
		console.log($scope.SOMInput);},2000);*/
            ...
            var timer6 = $timeout(function () {
                ...
                if ($scope.action.type == "load") {
                    ...
                    var options1 = {
                        url: "http://127.0.0.1:8089/trade/redescriptionElement",
                        method: 'GET',
                        params: {}
                    };
